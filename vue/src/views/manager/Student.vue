  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="speciality" label="专业"  :filters="headFilters['speciality']"
                         :filter-method="filterHandler"></el-table-column>
        <el-table-column prop="clazz" label="班级" :filters="headFilters['clazz']"
                         :filter-method="filterHandler"></el-table-column>
        <el-table-column label="操作" align="center" width="270">
          <template v-slot="scope">
            <el-button size="mini" type="primary" plain @click="handleEdit(scope.row)">编辑</el-button>
            <el-button size="mini" type="danger" plain @click="del(scope.row.id)">删除</el-button>
            <el-button size="mini" type="danger" plain @click="resetPassword(scope.row.id)">重置密码</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="学生" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="专业" prop="speciality">
          <el-input v-model="form.speciality" placeholder="专业"></el-input>
        </el-form-item>
        <el-form-item label="班级" prop="clazz">
          <el-input v-model="form.clazz" placeholder="班级"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    resetPassword(id) {
      this.$confirm('您确定重置密码吗？', '确认重置', {type: "warning"}).then(response => {
        this.$request.put('/student/resetPassword/' + id).then(res => {
